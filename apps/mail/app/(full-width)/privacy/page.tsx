...
export default function PrivacyPolicy() {
	...
	return (
		<T id="_full_width_.privacy.page.0">
								...
								<div className="space-y-2 text-center">
									...
									<div className="flex items-center justify-center gap-2">
										<p className="text-sm text-gray-500 dark:text-white/60">
											Last updated: <Var>{LAST_UPDATED}</Var>
										</p>
									</div>
								</div>
							</CardHeader>
...
const sections = [
	{
		...
		content: (
			<T id="_full_width_.privacy.page.1">
				<p>
					At Zero, we believe that privacy is a fundamental right. Our
					open-source email solution is built with privacy at its core, and
	...
	},
	{
		...
		content: (
			<>
				<T id="_full_width_.privacy.page.2">
					<p className="mb-4">When you use Zero with your Google Account:</p>
				</T>
				<T id="_full_width_.privacy.page.3">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.4">
				<div className="space-y-6">
					<div>
						...
						<ul className="ml-4 list-disc space-y-2">
							...
							<li>
								All data transmission between our service and Google is
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.5">
				<ul className="ml-4 list-disc space-y-2">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.6">
				<div className="space-y-6">
					<div>
						<h3 className="mb-3 text-lg font-medium">Data Access and Usage</h3>
						<ul className="ml-4 list-disc space-y-2">
							<li>
								We access the following Google user data: email content,
								attachments, and metadata through Gmail API
							</li>
							<li>
							...
							<li>
								No Google user data is used for advertising or marketing
								purposes
							</li>
							<li>
								We maintain detailed logs of all data access for security and
								compliance
							</li>
						</ul>
					</div>
					...
					<div>
						...
						<ul className="ml-4 list-disc space-y-2">
							...
							<li>
								All Google user data is permanently deleted when you revoke
								application access
							</li>
							<li>
								You can request immediate deletion of all your Google user data
								by contacting founders@0.email
							</li>
						</ul>
					</div>
				</div>
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.7">
				<div>
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.8">
				<ul className="ml-4 list-disc space-y-2">
	...
	},
	{
		title: "Contact",
		content: (
			<T id="_full_width_.privacy.page.9">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.privacy.page.10">
				<p>

...
export default function TermsOfService() {
	...
	return (
		<T id="_full_width_.terms.page.0">
...
const sections = [
	{
		title: "Overview",
		content: (
			<T id="_full_width_.terms.page.1">
				<p>
					0.email is an open-source email solution that enables users to
					self-host their email service or integrate with external email
					providers. By using 0.email, you agree to these terms.
				</p>
			</T>
		),
	},
	{
		...
		content: (
			<T id="_full_width_.terms.page.2">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.terms.page.3">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.terms.page.4">
				<div className="text-muted-foreground mt-4 space-y-3">
					...
					<ul className="ml-4 list-disc space-y-2">
						...
						<li>
							Users must include the original license and copyright notice
						</li>
					</ul>
				</div>
			</T>
	...
	},
	{
		...
		content: (
			<T id="_full_width_.terms.page.5">
				<div className="text-muted-foreground mt-4 space-y-3">
	...
	},
	{
		...
		content: (
			<T id="_full_width_.terms.page.6">
				<div className="text-muted-foreground mt-4 space-y-3">

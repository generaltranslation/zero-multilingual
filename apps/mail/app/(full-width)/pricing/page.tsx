...
export default function PricingPage() {
	...
	return (
		<T id="_full_width_.pricing.page.0">
				...
				<div className="container mx-auto mt-12 h-screen px-4 py-16 md:mt-24">
					...
					<div className="mx-auto grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
						...
						<div className="relative flex h-full flex-col rounded-xl border bg-[#121212] px-8 pb-4 pt-8">
							<h1 className="mb-4 text-center text-lg font-normal text-white/50">
								Free
							</h1>
							...
							<ul className="mb-6 w-full flex-grow space-y-2 text-left">
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> 1 email
									connection
								</li>
								...
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> AI writing
									assistant
								</li>
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> Auto
									labeling
									<span className="text-xs text-white/50">(25 per day)</span>
								</li>
								<li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                 <CircleX className="h-4 w-4 fill-white opacity-50" /> Priority customer support
						...
						<div className="relative flex h-full flex-col rounded-xl border bg-[#121212] px-8 pb-4 pt-8">
							...
							<ul className="mb-6 w-full flex-grow space-y-2 text-left">
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> Unlimited
									email connections
								</li>
								...
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> AI thread
									summaries
								</li>

								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> Verified
									checkmark
								</li>
							</ul>
                 ...
                 <CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> Management dashboard
								...
								<li className="flex items-center gap-2">
									<CircleCheck className="h-4 w-4 fill-[#2FAD71]" /> Priority
									customer support
								</li>
							</ul>

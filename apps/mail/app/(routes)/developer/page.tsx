...
const developerResources = [
	{
		...
		details:
			"Explore our REST APIs, WebSocket endpoints, and integration guides.",
		icon: Book,
		href: "/docs",
...
export default function DeveloperPage() {
	...
	return (
		<T id="_routes_.developer.page.0">
						...
						<div className="bg-background/95 supports-[backdrop-filter]:bg-background/60 sticky top-0 z-10 mb-8 backdrop-blur">
							...
							<div className="space-y-4">
								...
								<p className="text-muted-foreground text-base sm:text-lg">
									Everything you need to build with 0.email&apos;s APIs and
									tools.
								</p>
							</div>
						</div>
									...
									>
										<CardHeader className="sm:p-6">
											<div className="flex items-start gap-4 sm:items-center">
												<div
													className={`shrink-0 rounded-lg ${resource.bgColor} p-2.5`}
												>
													<resource.icon
														className={`h-5 w-5 sm:h-6 sm:w-6 ${resource.color}`}
													/>
												</div>
												<div>
							...
							<div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
								<div className="flex-1 space-y-1">
									...
									<p className="text-muted-foreground text-sm">
										...
										with our developer support team.
									</p>
								</div>

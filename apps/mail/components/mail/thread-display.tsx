...
export function ThreadDisplay() {
	...
	const hasMultipleParticipants =
		(emailData?.latest?.to?.length ?? 0) +
			(emailData?.latest?.cc?.length ?? 0) +
			1 >
		2;
	...
	return (
		...
		>
			...
			>
				{!id ? (
					<T id="components.mail.thread_display.1">
						<div className="flex h-full items-center justify-center">
							...
							<Var>
								{!isSidebarOpen && (
									<T id="components.mail.thread_display.0">
					...
					<T id="components.mail.thread_display.4">
						<>
							<T id="components.mail.thread_display.5">
								<div
									className={cn(
										"flex flex-shrink-0 items-center border-b border-[#E7E7E7] px-1 pb-1 md:px-3 md:pb-[11px] md:pt-[12px] dark:border-[#252525]",
										isMobile &&
											"bg-panelLight dark:bg-panelDark sticky top-0 z-10 mt-2",
									)}
								>
									<div className="flex flex-1 items-center gap-2">
										<TooltipProvider delayDuration={0}>
											<Tooltip>
												...
												>
													<Var>{t("common.actions.close")}</Var>
												</TooltipContent>
											</Tooltip>
										</TooltipProvider>
										<ThreadActionButton
										...
										<TooltipProvider delayDuration={0}>
											<Tooltip>
												...
												<TooltipContent
													...
													className="bg-white dark:bg-[#313131]"
												>
													<Var>{t("common.threadDisplay.archive")}</Var>
												</TooltipContent>
											</Tooltip>
										</TooltipProvider>
                           ...
                           : t('common.threadDisplay.enterFullscreen')}
													...
													{isInSpam || isInArchive || isInBin ? (
														...
														<>
															...
															>
																...
																<span>
																	{t("common.threadDisplay.moveToSpam")}
																</span>
															</DropdownMenuItem>
															{emailData.latest?.listUnsubscribe ||
															emailData.latest?.listUnsubscribePost ? (
																<T id="components.mail.thread_display.2">
																	<DropdownMenuItem
																		onClick={handleUnsubscribeProcess}
																	>
							...
							>
								<ScrollArea
									className={cn(
										"flex-1",
										isMobile ? "h-[calc(100%-1px)]" : "h-full",
									)}
									type="auto"
								>
									<div className="pb-4">
								...
								<Var>
									{!isSidebarOpen && (
										<T id="components.mail.thread_display.3">
											<div className="fixed bottom-4 right-4 hidden md:block">
												<Tooltip>
													<TooltipTrigger asChild>
														<Button

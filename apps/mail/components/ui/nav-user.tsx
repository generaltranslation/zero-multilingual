...
export function NavUser() {
	...
	const refetchBrainLabels = useCallback(() => {
		queryClient.invalidateQueries({
			queryKey: trpc.brain.getLabels.queryKey(),
		});
	}, [queryClient]);
	...
	const otherConnections = useMemo(() => {
		...
		return data.connections.filter(
			(connection) => connection.id !== activeAccount?.id,
		);
	}, [data, activeAccount]);
									...
									<div className="space-y-1">
										<>
											<p className="text-muted-foreground px-2 py-1 text-[11px] font-medium">
												<Var>{t("common.navUser.accounts")}</Var>
											</p>
											...
											>
												<div className="flex w-full items-center gap-2">
													...
													<p className="text-[13px] opacity-60">
														<Var>{t("common.navUser.appTheme")}</Var>
													</p>
												</div>
											</DropdownMenuItem>
											<DropdownMenuItem asChild>
												<a href={getSettingsHref()} className="cursor-pointer">
													<div className="flex items-center gap-2">
														...
														<p className="text-[13px] opacity-60">
															<Var>{t("common.actions.settings")}</Var>
														</p>
													</div>
												</a>
											</DropdownMenuItem>
											<DropdownMenuItem>
												...
												>
													<div className="flex items-center gap-2">
														...
														<p className="text-[13px] opacity-60">
															<Var>{t("common.navUser.customerSupport")}</Var>
														</p>
													</div>
												</a>
											</DropdownMenuItem>
											...
											>
												<div className="flex items-center gap-2">
													...
													<p className="text-[13px] opacity-60">
														<Var>{t("common.actions.logout")}</Var>
													</p>
												</div>
											</DropdownMenuItem>
										</>
									...
									{data && activeAccount ? (
										<div
											...
											className={`flex cursor-pointer items-center ${
												activeAccount.id === session.connectionId &&

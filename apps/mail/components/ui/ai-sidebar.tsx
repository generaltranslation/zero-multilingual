...
export const AISidebarContext = createContext<AISidebarContextType | undefined>(
	undefined,
);
...
export function AISidebar({
	children,
	className,
}: AISidebarProps & { children: React.ReactNode }) {
	...
	const isPro = useMemo(() => {
		return (
			...
			customer.products.some(
				(product: any) =>
					product.id.includes("pro-example") ||
					product.name.includes("pro-example"),
			)
		);
	}, [customer]);
	...
	return (
		<TooltipProvider delayDuration={0}>
			...
			>
				...
				{open && (
					<T id="components.ui.ai_sidebar.1">
						<>
							<T id="components.ui.ai_sidebar.2">
								<ResizablePanel
									defaultSize={20}
									minSize={20}
									maxSize={35}
										...
										<div className="flex h-full flex-col">
											<div className="relative flex items-center justify-between border-b border-[#E7E7E7] px-2.5 pb-2.5 pt-[17.6px] dark:border-[#252525]">
												...
												<div className="flex items-center gap-2">
													<Var>
														{!isPro && (
															<T id="components.ui.ai_sidebar.0">
																<TooltipProvider delayDuration={0}>
																	<Tooltip>
																		<TooltipTrigger
																			asChild
																		...
																		<TooltipContent>
																			<p>
																				You've used{" "}
																				<Var>
																					{50 - chatMessages.remaining!}
																				</Var>{" "}
																				out of 50 chat messages.
																			</p>
																			<p className="mb-2">
														...
														<Dialog>
															...
															<DialogContent showOverlay={true}>
																<DialogHeader>
																	...
																	<DialogDescription>
																		We believe in Open Source, so we're open
																		sourcing our AI system prompts. Soon you
																		will be able to customize them to your
																		liking. For now, here are the default
																		prompts:
																	</DialogDescription>
																</DialogHeader>

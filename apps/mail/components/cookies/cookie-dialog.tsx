...
export function CookieConsent({
	...
	const { preferences, updatePreference, acceptAll, rejectAll, isLoaded } =
		useCookies();
	...
	return (
		<>
			...
			<T id="components.cookies.cookie_dialog.0">
							...
							<DialogHeader>
								...
								<DialogDescription className="space-y-4">
									<span className="block text-sm text-zinc-600 dark:text-zinc-400">
										...
										experience. By clicking "Accept All", you consent to all
										cookies. You can customize your choices by clicking
										"Customize" or reject all optional cookies by clicking
										"Reject All".
									</span>
									<span className="block text-sm text-zinc-600 dark:text-zinc-400">
										For California residents (CCPA): We do not sell your
										personal information. However, some cookies collect data for
										targeted advertising. To opt out of the sale of your data
										for targeted advertising purposes, click "Reject All" or
										disable Marketing cookies below.
									</span>
									<span className="block text-sm text-zinc-600 dark:text-zinc-400">
										You can change your preferences at any time by clicking the
										cookie settings button in the corner of the screen. For more
								...
								<Accordion type="multiple" className="space-y-4">
									<Var>
										{(
											...
											<T id="components.cookies.cookie_dialog.10">
												<AccordionItem
													key={category}
													value={category}
													...
													<div className="flex items-center justify-between py-4">
														<div className="flex items-center space-x-2">
															...
															>
																...
																<Var>
																	{info.required && (
																		<T id="components.cookies.cookie_dialog.1">
														...
														<div className="space-y-3">
															...
															<div>
																...
																<p className="text-sm text-zinc-600 dark:text-zinc-400">
																	<Var>
																		{category === "necessary" ? (
																			<T id="components.cookies.cookie_dialog.2">
																				{
																					"Session - These cookies are deleted when you close your browser"
																				}
																			</T>
																		) : category === "functional" ? (
																			<T id="components.cookies.cookie_dialog.3">
																				{
																					"1 year - To remember your preferences"
																				}
																			</T>
																		) : category === "analytics" ? (
																			<T id="components.cookies.cookie_dialog.4">
																				{
																					"2 years - To maintain consistent analytics data"
																				}
																			</T>
																		) : (
																			<T id="components.cookies.cookie_dialog.5">
																				{
															...
															<div>
																...
																<p className="text-sm text-zinc-600 dark:text-zinc-400">
																	<Var>
																		{category === "necessary" ? (
																			<T id="components.cookies.cookie_dialog.6">
																				{"First party - Set by us"}
																			</T>
																		) : category === "functional" ? (
																			<T id="components.cookies.cookie_dialog.7">
																				{
																					"First party and selected third parties"
																				}
																			</T>
																		) : category === "analytics" ? (
																			<T id="components.cookies.cookie_dialog.8">
																				{
																					"Google Analytics and similar services"
																				}
																			</T>
																		) : (
																			<T id="components.cookies.cookie_dialog.9">
			...
			{showBanner && (
				<T id="components.cookies.cookie_dialog.11">
					<Card className="animate-in fade-in slide-in-from-bottom-4 fixed bottom-4 left-4 right-4 z-40 border-zinc-200 bg-white p-4 shadow-lg duration-300 md:left-auto md:right-4 md:max-w-md dark:border-zinc-800 dark:bg-black">
						...
						<p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
							...
							this site you agree to our use of cookies. For California
							residents: We do not sell personal information, but some cookies

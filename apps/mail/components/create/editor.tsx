...
const MenuBar = () => {
	...
	return (
		<>
					...
					<div className="button-group ml-0 mt-1 flex flex-wrap gap-1 border-b pb-2">
						<div className="mr-2 flex items-center gap-1">
							<Tooltip>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.bold")}
								</TooltipContent>
							</Tooltip>
							<Tooltip>
								<TooltipTrigger asChild>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.italic")}
								</TooltipContent>
							</Tooltip>
							<Tooltip>
								<TooltipTrigger asChild>
							...
							<Tooltip>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.underline")}
								</TooltipContent>
							</Tooltip>
							<Tooltip>
								<TooltipTrigger asChild>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.link")}
								</TooltipContent>
							</Tooltip>
						</div>
						...
						<Separator
							...
							className="relative right-1 top-0.5 h-6"
						/>
						...
						<div className="flex items-center gap-1">
							<Tooltip>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.bulletList")}
								</TooltipContent>
							</Tooltip>
							<Tooltip>
								<TooltipTrigger asChild>
								...
								<TooltipContent>
									{t("pages.createEmail.editor.menuBar.orderedList")}
								</TooltipContent>
							</Tooltip>
						</div>
					</div>
			...
			<T id="components.create.editor.0">
				<Dialog open={linkDialogOpen} onOpenChange={setLinkDialogOpen}>
					<DialogContent className="sm:max-w-md">
						<DialogHeader>
							<DialogTitle>
								<Var>{t("pages.createEmail.addLink")}</Var>
							</DialogTitle>
							<DialogDescription>
								<Var>{t("pages.createEmail.addUrlToCreateALink")}</Var>
							</DialogDescription>
						</DialogHeader>
						...
						<DialogFooter className="flex justify-between sm:justify-between">
							<Button
								...
								type="button"
							>
								<Var>{t("common.actions.cancel")}</Var>
							</Button>
							<Button onClick={handleSaveLink} type="button">
								<Var>{t("common.actions.save")}</Var>
							</Button>
						</DialogFooter>
					</DialogContent>
				</Dialog>
...
export default function Editor({
	...
	return (
		<T id="components.create.editor.1">
			<div
				...
				<EditorRoot>
					...
					>
						...
						<EditorMenu
							open={openAI}
							onOpenChange={(open) =>
								dispatch({ type: "TOGGLE_AI", payload: open })
							}
						>

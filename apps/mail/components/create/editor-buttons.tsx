...
const MenuBar = () => {
	...
	return (
		<T id="components.create.editor_buttons.0">
	...
	return (
		<div className="flex items-center gap-2">
			...
			{attachments.length > 0 && (
				<T id="components.create.editor_buttons.3">
					<Popover>
						<PopoverTrigger asChild>
							...
							>
								<Var>{attachments.length}</Var> Files
							</button>
						</PopoverTrigger>
									...
									<p className="text-muted-foreground text-sm">
										...
										<Var>
											{attachments.length === 1 ? (
												<T id="components.create.editor_buttons.1">{"file"}</T>
											) : (
												<T id="components.create.editor_buttons.2">{"files"}</T>
											)}
										</Var>
									</p>
								</div>
									...
									<div className="grid grid-cols-2 gap-2">
										<Var>
											{attachments.map((file, index) => (
												<T id="components.create.editor_buttons.4">
													<div
														key={index}
													...
													>
														...
														<div className="bg-muted/10 p-2">
															<p className="text-xs font-medium">
																<Var>{truncateFileName(file.name, 20)}</Var>
															</p>
